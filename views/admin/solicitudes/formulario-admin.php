<div class="contenedor-solicitud">
    ...
    <div class="datos-estudiante">
        ...
        <div class="campo">
            ...
            <input type="text" value="<?php echo ucwords($solicitud->nombres); ?>" disabled>
        </div>

        <div class="campo">
            <label for="apellidos">Apellido(s)</label>
            <input type="text" value="<?php echo ucwords($solicitud->apellidos); ?>" disabled>
        </div>

        <div class="campo">
            <label for="cedula">Cedula</label>
            <input type="text" value="<?php echo $solicitud->cedula; ?>" disabled>
        </div>
